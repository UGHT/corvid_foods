summon item ~ ~ ~ {Item:{id:"minecraft:suspicious_stew",Count:1b,tag:{display:{Name:'{"text":"Chorus Cake","color":"aqua","italic":false}'},CustomModelData:1201,Effects:[{EffectId:25b,EffectDuration:400},{EffectId:28b,EffectDuration:600}]}}}
